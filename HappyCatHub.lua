...
ggame.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://";
      Title = "Happy cat hub Hub", 
...
ImageButton.Image = "http://www.roblox.com/asset/?id=104450799419041"
...
if not game:IsLoaded() then
    ...
    getAllBladeHits = Fast_1(function(Sizes)
        local Hits = {}
        local Client = game.Players.LocalPlayer
        local Enemies = game:GetService("Workspace").Enemies:GetChildren()
        for i,v in pairs(Enemies) do
    ...
    getAllBladeHitsPlayers = Fast_1(function(Sizes)
        local Hits = {}
        local Client = game.Players.LocalPlayer
        local Characters = game:GetService("Workspace").Characters:GetChildren()
        for i,v in pairs(Characters) do
    ...
    local MaxFire = 1000
    local FireCooldown = 0.0006
    local FireL = 0
    local bladehit = {}
    
    CancelCoolDown = Fast_2(function()
    ...
    AttackFunction = Fast_2(function(typef)
        local ac = CombatFrameworkR.activeController
        if ac and ac.equipped then
            local bladehit = {}
            if typef == 1 then
